...
const projects = [
  { url: "https://online-vehicle-rental.netlify.app/", img: VehicleRental, alt: "Vehicle Rental Service", text: "Online Vehicle Page",description: "This is a brief description of the Online Vehicle Rental Service.",skills: ["HTML", "JavaScript", "React", "Node", "MongoDB"],codeLink: "https://github.com/example/vehicle-rental-code" },
  { url: "https://moviesearch00.netlify.app/", img: MoviesSearch, alt: "Movies Search: Your Movie Journey Starts Here!", text: "Movies Search: Your Movie Journey Starts Here!" },
  { url: "https://router0.netlify.app/", img: AddtoCart, alt: "Product Preview Card Component", text: "Add to Cart" },
  { url: "https://incomeexpensecalculator00.netlify.app/", img: Calculator, alt: "Product Preview Card Component", text: "Income Expense Calculator" },
  { url: "https://memorycardgame0.netlify.app/", img: MemoryGame, alt: "Product Preview Card Component", text: "Memory Card Game" },
  ...
  return (
    <div className="min-h-screen bg-black text-white font-stylish p-10">
      ...
      <div className="flex justify-center mt-8">
        <button className="w-12 h-12 bg-gray-800 rounded-full mx-4 hover:bg-[#d4af37] shadow-lg transform hover:scale-105 transition-transform duration-300 flex items-center justify-center" onClick={handlePrev}>
          <FontAwesomeIcon icon={faChevronLeft} className="text-white text-2xl" />
        </button>
        <button className="w-12 h-12 bg-gray-800 rounded-full mx-4 hover:bg-[#d4af37] shadow-lg transform hover:scale-105 transition-transform duration-300 flex items-center justify-center" onClick={handleNext}>
